  ...
  return (
    <div>
      <div className="max-w-md mx-auto flex justify-center relative">
        ...
        <Link
          href={link}
          className="group font-medium tracking-wide select-none text-lg relative inline-flex items-center justify-center cursor-pointer h-12 border border-solid py-0 px-6 rounded-md overflow-hidden z-10 transition-all duration-300 ease-in-out outline-0 bg-primary text-white border-white hover:text-primary focus:text-primary"
        >
