      ...
      <Sheet>
        <SheetTrigger asChild>
          <Image
            ...
            className="bg-white w-10 p-1 rounded-md"
          />
        </SheetTrigger>
        <SheetContent>
          <SheetHeader>
            ...
            <ul className="text-start">
              <li>
                <a
                  href="#"
                  className="flex items-center text-nowrap text-black rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white"
                  aria-current="page"
                >
                  <AlignJustifyIcon
                    className="mr-2"
